...
#set value for text size so consistent across figures
eltext <- 12
...
# set grid
h_grid <- seq(from=0, to=2, length.out = 101)
...
data %>%
  ggplot(aes(g, h)) + geom_raster(aes(fill=iqr_ratio)) + scale_fill_gradient(low="white", high=muted("red")) +
